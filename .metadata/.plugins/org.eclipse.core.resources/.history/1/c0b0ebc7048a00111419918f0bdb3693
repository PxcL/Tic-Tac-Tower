...
public class Textures {
	...
	public final static Texture BUTTON_SILENCE_ACTIVE = new Texture("sile_active.png");
	public final static Texture BUTTON_SILENCE_DEACTIVE = new Texture("sile_deactive.png");
